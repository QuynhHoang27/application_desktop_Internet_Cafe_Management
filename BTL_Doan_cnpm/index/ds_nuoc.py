...
class ds_nuoc(QMainWindow):
    def __init__(self,ten_tai_khoan):
        super(ds_nuoc,self).__init__()
        uic.loadUi('/Users/hoangquynh/BTL_DOAN_CNPM/interface/interface_nuocuong_nguoidung.ui',self)
        self.loadata()
    ...
    def loadata(self, ten_dich_vu=None):
        ...
        # Truy vấn SQL
        if ten_dich_vu:
            sql = "SELECT ma_dich_vu, ten_dich_vu, loai_dich_vu, don_gia, trang_thai FROM quan_ly_dich_vu WHERE ten_dich_vu LIKE 'Nước uống:%'"
            value = f"%{ten_dich_vu}%"
